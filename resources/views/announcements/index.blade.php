        ...
        <div class="max-w-3xl mx-auto pt-8">
            ...
            @if(count($announcements) < 1)
                <div class="rounded-lg w-full px-8 py-6 bg-white">
                    <p class="mt-2 text-gray-600 text-sm mb-4">No Unread Announcements</p>
                    <a href="{{ route('announcements') }}" class="bg-orange-600 p-2 rounded text-sm text-white">All Past Announcements</a>
                </div>
            @endif
        </div>
    </div>
