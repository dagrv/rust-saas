<footer class="bg-gray-900 text-white pt-12 pb-8 px-4">
    <div class="mx-auto px-4 container overflow-hidden flex flex-col lg:flex-row justify-between">
        <a href="/" class="block mr-2">
            <img src="/img/footer_img2.png" class="w-40 ml-4 lg:ml-0" alt="logo">
        </a>
        <div class="w-2/3 block sm:flex text-sm mt-6 lg:mt-0">
            <ul class="text-white list-none p-0 font-thin flex flex-col text-left w-full">
                ...
                <li><a href="#" class="inline-block py-2 px-3 text-white hover:text-white no-underline">Features</a></li>
                <li><a href="#" class="inline-block py-2 px-3 text-white hover:text-white no-underline">Integrations</a></li>
                <li><a href="#" class="inline-block py-2 px-3 text-white hover:text-white no-underline">Pricing</a></li>
                <li><a href="#" class="inline-block py-2 px-3 text-white hover:text-white no-underline">FAQ</a></li>
            </ul>
            <ul class="text-gray-700 list-none p-0 font-thin flex flex-col text-left w-full">
                ...
                <li><a href="/p/privacy" class="inline-block py-2 px-3 text-white hover:text-white no-underline">Privacy</a></li>
                <li><a href="/p/terms" class="inline-block py-2 px-3 text-white hover:text-white no-underline">Terms of Service</a></li>
            </ul>
            <ul class="text-gray-700 list-none p-0 font-thin flex flex-col text-left w-full">
                <li class="inline-block py-2 px-3 text-white uppercase font-medium tracking-wide">Developers</li>
                    <li><a href="#" class="inline-block py-2 px-3 text-white hover:text-white no-underline">Developer API</a></li>
                    <li><a href="#" class="inline-block py-2 px-3 text-white hover:text-white no-underline">Documentation</a></li>
                    <li><a href="#" class="inline-block py-2 px-3 text-white hover:text-white no-underline">Guides</a></li>
                </li>
            </ul>
    ...
    <div class="pt-4 mt-4 pt-6 text-gray-600 border-t border-gray-800 text-center"> © 2020 rust-software. All rights reserved.</div>
</footer>