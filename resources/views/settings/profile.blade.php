            ...
            <form action="{{ route('profile.save') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="w-full bg-white rounded-lg mx-auto mt-8 flex overflow-hidden rounded-b-none">
                    ...
                    <div class="md:w-2/3 w-full">
                        ...
                        <img class="rounded-full w-16 h-16 border-4 mt-2 border-green-200 float-left" id="photo" src="{{ auth()->user()->photo }}" alt="photo">
                ...
                <div class="p-16 py-8 bg-white clearfix rounded-b-lg border-t border-gray-200">
                    <p class="float-left text-sm text-gray-500 tracking-tight mt-2">Click on Save to update your Profile Info</p>
