    ...
    <div class="flex h-screen bg-gray-100 p-4 rotate">
        <div class="sm:max-w-xl md:max-w-2xl w-full m-auto">
            <form method="POST" action="{{ route('register') }}" class="flex items-stretch bg-white rounded-lg shadow-lg overflow-hidden border-t-4 border-indigo-500 sm:border-0">
                ...
                <div class="flex hidden overflow-hidden relative sm:block w-5/12 md:w-6/12 bg-gray-600 text-gray-300 py-4 bg-cover bg-center" style="background-image: url('/img/berlin.jpg')">
                ...
                <div class="flex-1 p-6 sm:p-10 sm:py-12">
                    ...
                    <p class="w-full text-xs text-left text-gray-700 mt-8">
                        ...
                        <a class="text-blue-500 hover:text-blue-700 ml-1 font-normal no-underline" href="{{ route('login') }}">
                            Login
                        </a>
                    </p>
                </div>
