...
<body>
    ...
    <div class="bg-white">
        <div class="container mx-auto h-auto md:h-20 md:flex justify-between items-center">
            <a href="/" class="block md:inline-block text-center font-black text-gray-800 text-2xl my-4 md:my-0">{{ $course->name }}<span class="text-green-500">.</span></a>
            <a href="/#" class="bg-{{ $course->primary_color }}-500 px-5 py-2 text-white hidden md:block rounded-lg">Enroll Now</a>
        </div>
    </div>
    ...
    <div class="bg-gray-100">
        <div class="lg:flex container mx-auto">
            <div class="w-full lg:w-1/2 pl-0 lg:pl-12 text-center lg:text-left flex justify-center items-start flex-col pt-8 lg:pt-0">
                <p class="text-green-500 font-medium text-xl tracking-wider w-full lg:w-auto">Tagline</p>
    ...
    <div class="white">
        <div class="container mx-auto flex justify-center items-center flex-col py-24">
            ...
            <a href="/#" class="inline-block w-auto bg-{{ $course->primary_color }}-500 px-8 py-4 text-white text-xl mt-10 rounded-lg">Enroll Now</a>
        </div>
    </div>
    ...
    <div class="bg-gray-100">
        <div class="container mx-auto flex justify-center items-center flex-col py-24">
            <p class="text-green-500 font-medium text-lg tracking-wider">The Videos</p>
    ...
    <div class="bg-white">
        <div class="container mx-auto flex justify-center items-center flex-col py-24">
            <p class="text-green-500 font-medium text-lg tracking-wider">Testimonials</p>
            ...
            <div class="lg:flex justify-center items-center w-full mt-16 mb-4">
                <div class="h-auto w-full lg:w-1/3 mb-12 lg:mb-0 flex justify-start items-start flex-col">
                    ...
                    <blockquote class="text-gray-600 mt-8 text-lg">"I've taken many online courses and this is by far the most thorough and knowledge-packed course I've ever taken."</blockquote>
                </div>
                <div class="h-auto w-full lg:w-1/3 mb-12 lg:mb-0 px-0 lg:px-8 mx-0 lg:mx-8 flex justify-start items-start flex-col border-transparent border-r border-l lg:border-gray-200">
                    ...
                    <blockquote class="text-gray-600 mt-8 text-lg">"I really enjoyed this course. I learned so many things that are going to help me further my development career."</blockquote>
                </div>
                <div class="h-auto w-full lg:w-1/3 flex justify-start items-start flex-col">
                    ...
                    <blockquote class="text-gray-600 mt-8 text-lg">"Packed with awesome content, this course has helped me master technology A. I would highly recommend this to anyone."</blockquote>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="bg-gray-100 py-24">
        <div class="max-w-4xl mx-auto md:flex">
            <div class="w-full md:w-1/2 bg-white shadow pb-12 mr-4 mb-8 md:mb-0">
                ...
                <div class="px-10">
                    <div class="flex mt-10 items-end">
                        <h4 class="text-gray-700 text-5xl font-black leading-snug">$68</h4>
                        <p class="text-sm text-green-500 ml-2 mb-3">one-time payment</p>
                    </div>
                    ...
                    <div class="h-32">
                        <p class="border-t border-gray-100 mt-4 pt-4 font-bold text-gray-700 text-sm">What You Get</p>
                        <div class="text-base font-medium mt-4 text-gray-700 flex justify-start items-center">
                            <svg class="w-4 h-4 fill-current text-green-500 mr-2 mt-1" xmlns="http://www.w3.org/2000/svg"><g stroke="none" stroke-width="1"><g transform="translate(-1 -3)"><path d="M14.305 3.344l1.06 1.061-8.75 8.751-5.038-5.038 1.06-1.06 3.977 3.977z"/></g></g></svg>
                            Feature 1
                        </div>
                        <div class="text-base font-medium mt-4 text-gray-700 flex justify-start items-center">
                            <svg class="w-4 h-4 fill-current text-green-500 mr-2 mt-1" xmlns="http://www.w3.org/2000/svg"><g stroke="none" stroke-width="1"><g transform="translate(-1 -3)"><path d="M14.305 3.344l1.06 1.061-8.75 8.751-5.038-5.038 1.06-1.06 3.977 3.977z"/></g></g></svg>
                    ...
                    <a href="/#" class="block w-auto bg-{{ $course->primary_color }}-500 px-8 py-4 text-white text-xl rounded-lg mt-16 text-center">Buy Now</a>
                </div>
            </div>
            ...
            <div class="w-full md:w-1/2 bg-white shadow pb-12 ml-0 md:ml-4">
                ...
                <div class="px-10">
                    <div class="flex mt-10 items-end">
                        <h4 class="text-gray-700 text-5xl font-black leading-snug">$99</h4>
                        <p class="text-sm text-green-500 ml-2 mb-3">one-time payment</p>
                    </div>
                    ...
                    <a href="/#" class="block w-auto bg-{{ $course->primary_color }}-500 px-8 py-4 text-white text-xl mt-16 rounded-lg text-center">Buy Now</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white py-12">
        <div class="container mx-auto px-6 md:px-0 md:flex justify-between items-center">
            <a href="/" class="inline-block font-black text-gray-800 text-2xl">RSTW - Learn<span class="text-green-500">.</span></a>
            <div class="text-gray-700 font-bold -mt-2 text-xl">Never Stop Learning<span class="text-pink-500 text-3xl">.</span></div>
        </div>
